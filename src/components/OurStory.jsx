          ...
          >
            <div className="bg-white/80 backdrop-blur-sm border border-[#C6AC8F]/30 rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                {/* LEFT */}
                <div className="relative p-6 sm:p-10 lg:p-14 pt-28">
                  <div
                  ...
                  <div className="relative z-10">
                    ...
                    <motion.div variants={itemVariants} className="mt-8">
                      <button
                        ...
                        className="inline-flex items-center gap-3 px-8 py-4 text-sm font-semibold text-black/70 rounded-full
                                   bg-gradient-to-r from-[#5A503C]/50 to-[#C6AC8F]/60 hover:bg-[#C6AC8F]
                                   hover:shadow-xl transition lg:w-38 lg:h-38 rounded-full border-1 border-transparent hover:border-white cursor-pointer"
                      >
                ...
                {/* RIGHT */}
                <div className="relative p-6 sm:p-10 lg:p-14 bg-[#d4c6ae]/70">
                  <motion.div
                    variants={containerVariants}
                    className="space-y-5"
                  >
                    {services.map((service) => (
                      <motion.article
                        ...
                        whileHover="hover"
                        className="bg-white/90 p-6 rounded-2xl border border-[#C6AC8F]/30 shadow-lg"
                      >
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-[#C6AC8F] to-[#5A503C] text-white text-xl">
                            {service.icon}
                          </div>
