        ...
        <div className="px-6 lg:px-12 py-8 lg:py-12">
            ...
            <div className="flex flex-col lg:flex-1">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
                ...
                <div className="text-[#EAE0D5]">
                  ...
                  <p className="text-sm text-[#C6AC8F]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-6 border-t border-[#5E503F] text-sm">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-[#EAE0D5]">
                <span className="text-white/80">Phone: </span>+254 745 119 904
                <br />
                <span className="text-white/80">Email: </span>
                hello@orbit-craft.co.ke
              </p>
            </div>
            <div className="text-center md:text-left">
              <h5 className="text-[#C6AC8F] font-semibold mb-2">
                Business Hours
              </h5>
              <p className="text-[#EAE0D5]">
