...
// ServiceCard Component - Moved outside the main component
...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Services | Orbit Craft</title>
        <meta
          name="description"
          content="Explore Orbit Craft's professional services including residential and commercial design, interior design, construction, and real estate advisory in Kenya."
        />
        <meta
          name="keywords"
          content="construction services Kenya, architectural design, interior design, real estate advisory, building construction"
        />
        <meta property="og:title" content="Our Services | Orbit Craft" />
        <meta
          property="og:description"
          content="Comprehensive construction, design, and real estate services tailored to your vision."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://orbit-craft.co.ke/services" />
        <meta property="og:image" content="https://orbit-craft.co.ke/services" />
        ...
        <div className="relative w-full container-responsive pt-24 sm:pt-28 lg:pt-32">
          ...
          >
            ...
            <motion.div
              ...
              className="h-1 bg-gradient-to-r from-[#5E503F] via-[#C6AC8F] to-[#5E503F] mx-auto mb-4 sm:mb-5 lg:mb-6 sm:w-[120px] lg:w-[140px]"
            />
