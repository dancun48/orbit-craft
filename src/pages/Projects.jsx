        ...
        <div className="relative max-w-10xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-sm font-semibold text-[#5E503F] tracking-wider uppercase">
                Our Portfolio
              </span>
              <div className="w-12 h-[2px] bg-[#5E503F]/40"></div>
            </div>
          ...
          >
            <div className="relative max-w-md mx-auto">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <MagnifyingGlassIcon className="h-5 w-5 text-[#5E503F]" />
              </div>
              <input
                type="text"
                ...
                className="w-full pl-10 pr-4 py-3 bg-white border border-[#5E503F]/20 rounded-full focus:outline-none focus:ring-2 focus:ring-[#5E503F]/50 focus:border-transparent text-[#0A0908] placeholder-gray-500 shadow-sm"
              />
            </div>
          </motion.div>
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`group flex items-center gap-2 px-4 py-2.5 rounded-full transition-all duration-300 border ${
                    filter === category.id
                ...
                >
                  <Icon className={`w-4 h-4 transition-transform duration-300 ${
                    filter === category.id ? 'scale-110' : 'group-hover:scale-110'
                  }`} />
          ...
          >
            <AnimatePresence>
              {filteredProjects.map((project, index) => (
                ...
                >
                  {/* Project Card */}
                  <div className="relative h-full bg-white rounded-xl overflow-hidden border border-[#5E503F]/10 shadow-sm hover:shadow-md transition-all duration-300">
                    {/* Image Container */}
                    <div className="relative h-56 overflow-hidden">
                      ...
                      {/* Project Number */}
                      <div className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 border border-[#5E503F]/20 flex items-center justify-center text-[#5E503F] font-bold text-sm shadow-sm">
                        {project.id + 1}
                      </div>
                    </div>
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-1.5 mb-2">
                        <MapPinIcon className="w-4 h-4 text-[#5E503F]" />
                        <span className="text-xs text-gray-600">{project.location}</span>
                      </div>
                      
                      <h3 className="text-lg font-bold text-[#0A0908] mb-2 group-hover:text-[#5E503F] transition-colors duration-300 line-clamp-1">
                        {project.title}
                      </h3>
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <motion.button
                          ...
                          className="group/btn w-full flex items-center justify-center gap-1.5 text-sm font-medium text-[#5E503F] hover:text-white bg-[#5E503F]/5 hover:bg-[#5E503F] py-2.5 rounded-lg transition-all duration-300"
                    ...
                    {/* Hover border */}
                    <div className="absolute inset-0 border-2 border-[#5E503F] rounded-xl opacity-0 group-hover:opacity-30 transition-opacity duration-300 pointer-events-none" />
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          {filteredProjects.length === 0 && (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-white border border-[#5E503F]/20 flex items-center justify-center shadow-sm">
                <BuildingOfficeIcon className="w-8 h-8 text-[#5E503F]" />
              </div>
              <h3 className="text-xl font-bold text-[#0A0908] mb-2">No Projects Found</h3>
              ...
              {(searchTerm || filter !== 'all') && (
                <button
                  ...
                  className="mt-4 text-sm font-medium text-[#5E503F] hover:text-[#0A0908] transition-colors duration-300"
                >
          ...
          <motion.div 
            ...
            className="bg-white rounded-xl border border-[#5E503F]/10 p-8 shadow-sm"
          >
      ...
      <AnimatePresence>
        {selectedProject !== null && selectedProjectData && (
          <>
            ...
            >
              <div className="bg-[#eae5df] rounded-xl lg:rounded-2xl border border-[#5E503F]/20 h-full overflow-hidden flex flex-col shadow-xl">
                {/* Header */}
                <div className="p-5 lg:p-6 border-b border-[#5E503F]/20 flex items-center justify-between bg-white/50">
                  <div>
                    <h2 className="text-xl lg:text-2xl font-bold text-[#0A0908]">
                      {selectedProjectData.title}
                    </h2>
                    <div className="flex items-center gap-3 mt-1">
                      <span className="text-xs text-[#5E503F] bg-[#5E503F]/10 px-2 py-1 rounded-full">
                  ...
                  <button
                    onClick={closeDetails}
                    className="text-gray-500 hover:text-[#5E503F] p-2 rounded-full hover:bg-[#5E503F]/10 transition-colors duration-300"
                ...
                <div className="flex-1 overflow-y-auto modal-content">
                  <div className="p-5 lg:p-6">
                    {/* Image Gallery */}
                    <div className="relative h-56 sm:h-64 md:h-72 rounded-lg overflow-hidden mb-4 group border border-[#5E503F]/20">
                      <motion.img
                      ...
                      <button
                        onClick={prevImage}
                        className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-[#5E503F] p-2 rounded-full transition-all duration-300 transform hover:scale-110 opacity-0 group-hover:opacity-100 border border-[#5E503F]/20"
                      ...
                      <button
                        onClick={nextImage}
                        className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-[#5E503F] p-2 rounded-full transition-all duration-300 transform hover:scale-110 opacity-0 group-hover:opacity-100 border border-[#5E503F]/20"
                      ...
                      {/* Image Counter */}
                      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 bg-white text-[#5E503F] px-3 py-1 rounded-full text-xs border border-[#5E503F]/20">
                      ...
                      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
                        {selectedProjectData.gallery.map((img, idx) => (
                          <motion.button
                            ...
                            className={`flex-shrink-0 w-14 h-14 md:w-16 md:h-16 rounded overflow-hidden transition-all duration-300 border ${
                    ...
                    {/* Quick Info Section */}
                    <div className="mb-6 p-4 bg-white rounded-lg border border-[#5E503F]/20">
                      <div className="grid grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={idx} className="text-center">
                            <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#5E503F]/10 mb-2">
                              <item.icon className="w-4 h-4 text-[#5E503F]" />
                            </div>
                            <div className="text-xs text-gray-600">{item.label}</div>
                            <div className="text-[#0A0908] font-medium text-sm">{item.value}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Project Overview */}
                    <div className="mb-6">
                      <h3 className="text-lg font-bold text-[#0A0908] mb-3 flex items-center gap-2">
                        <SparklesIcon className="w-5 h-5 text-[#5E503F]" />
                        Project Overview
                      </h3>
                    ...
                    {/* Key Features */}
                    <div className="mb-6">
                      <h3 className="text-lg font-bold text-[#0A0908] mb-4">Key Features</h3>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {selectedProjectData.features.map((feature, idx) => (
                          <div
                            key={idx}
                            className="bg-white p-3 rounded-lg border border-[#5E503F]/20"
                          >
                            <div className="flex items-center gap-2">
                              <div className="w-6 h-6 rounded-full bg-[#5E503F]/10 flex items-center justify-center">
                    ...
                    {/* Project Status */}
                    <div className="p-4 bg-white rounded-lg border border-[#5E503F]/20">
                      <h3 className="text-lg font-bold text-[#0A0908] mb-2">Project Status</h3>
                ...
                {/* Footer */}
                <div className="p-5 lg:p-6 border-t border-[#5E503F]/20 bg-white/50">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <motion.button
                      onClick={closeDetails}
                      className="flex-1 border border-[#5E503F] text-[#5E503F] hover:bg-[#5E503F]/5 px-4 py-2.5 rounded-lg font-medium transition-colors duration-300"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
